...
- **[06-status-2026-06-04.md](06-status-2026-06-04.md)** — Neon production DB kuruldu, backend/frontend Vercel deploy edildi, live API smoke testleri geçti.
- **[07-ideas-2026-06-07.md](07-ideas-2026-06-07.md)** — Ürün/İş/İçerik fikirleri: 10+7+7 tek satırlık fikir listesi. Pilot ve go-to-market için stratejik yönler.
- **[08-status-2026-06-09.md](08-status-2026-06-09.md)** — CURRENT. UI & Design: Demo ağ bypass, TypeScript fix, Salesforce Lightning tasarım, Inter font entegrasyonu. Prod deployment başarılı.
